...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/students/Simple-Slider.css">
</head>
<style>
img.barcode {
...
<body style="color: rgb(0,0,0);font-size: 15px;text-align: center;">
	...
	<div class="container"><a class="navbar-brand" href="#" style="color: rgb(255,255,255);font-size: 35px;font-style: normal;font-family: Bitter, serif;">Food Pantry</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
		...
		</ul><span class="navbar-text actions"> <a class="btn btn-light action-button" role="button" href="./Homepage.php" style="background: #ffc629;color: rgb(0,0,0);">Sign Out</a></span>
	    </div>
	</div>
    </nav>
	...
	<footer>
		...
		<div class="row justify-content-center" style="background: #0c1975;">
			...
			<ul></ul><small style="color: rgb(255,255,255);"><br>California State University, Bakersfield 9001 Stockdale Highway Bakersfield, CA 93311 (661)-654-CSUB<br></small><img class="img-fluid float-right bounce animated" src="./assets/img/food_pantry_image.jpg" width="100" height="100" style="margin: 5px;padding: 5px;">
		    </div>
		</div>
	    </div>
	</footer>
