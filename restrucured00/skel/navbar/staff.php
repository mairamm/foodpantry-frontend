...
<body style="color: rgb(0,0,0);font-size: 17px;">
	...
	<div class="container"><a class="navbar-brand" href="https://cs.csubak.edu/~lsamha/foodpantry-frontend/restrucured00/staff.php" style="color: rgb(255,255,255);font-size: 35px;font-style: normal;font-family: 'Roboto Slab', serif;">FP Staff Menu</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
	    <div class="collapse navbar-collapse" id="navcol-1">
		<ul class="nav navbar-nav mr-auto">
		<li class="nav-item"><a class="nav-link" href="https://cs.csubak.edu/~lsamha/foodpantry-frontend/restrucured00/staff/inventoryC/add_item.php" style="color: rgb(255,255,255);font-family: 'Roboto Slab', serif;"><strong>ADD</strong></a></li>
	    ...
	    <li class="nav-item"><a class="nav-link" href="https://cs.csubak.edu/~lsamha/foodpantry-frontend/restrucured00/staff/consumerC.php" style="color: rgb(255,255,255);font-family: 'Roboto Slab', serif;"><strong>ACCOUNTS</strong></a></li>
        <li class="nav-item"><a class="nav-link active" href="https://cs.csubak.edu/~lsamha/foodpantry-frontend/restrucured00/staff/consumerC/register_consumer.php" style="color: rgb(255,255,255);font-family: 'Roboto Slab', serif;"><strong>REGISTER NEW</strong></a></li>
        <li class="nav-item"><a class="nav-link active" href="https://cs.csubak.edu/~lsamha/foodpantry-frontend/restrucured00/staff/staffC/checkout.php" style="color: rgb(255,255,255);font-family: 'Roboto Slab', serif;"><strong>CHECK OUT</strong></a></li>
