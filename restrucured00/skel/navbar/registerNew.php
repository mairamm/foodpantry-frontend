...
<body style="color: rgb(0,0,0);font-size: 17px;">
    ...
    <nav class="navbar navbar-lit navbar-expand-md navigation-clean-button" style="background: #0c1975;">
        <div class="container"><a class="navbar-brand" href="../restrucured00/staff.php" style="color: rgb(255,255,255);font-size: 35px;font-style: normal;font-family: 'Roboto Slab', serif;">Food Pantry</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
    ...
    <form method="post">
      <span class="navbar-text actions"><input type="submit" name="QRCodeGenButton" id="QRCodeGenButton" role="button" href="#" value="Generate New QRCode" style="background: #ffc629;color: rgb(12, 25, 117);font-family: 'Roboto Slab', serif;float: right;"></input></span>
    </form>
        </div>
    </nav>
</body>
