...
<body style="color: rgb(0,0,0);font-size: 17px;">
	...
	<div class="container"><a class="navbar-brand" href="../../staff.php" style="color: rgb(255,255,255);font-size: 35px;font-style: normal;font-family: 'Roboto Slab', serif;">Food Pantry</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
		...
		<ul class="nav navbar-nav mr-auto">
		    ...
		    <li class="nav-item"><a class="nav-link" href="./update_item.php" style="color: rgb(255,255,255);font-family: 'Roboto Slab', serif;"><strong>UPDATE</strong></a></li>
	 <li class="nav-item"><a class="nav-link" href="./delete_item.php" style="color: rgb(255,255,255);font-family: 'Roboto Slab', serif;"><strong>DELETE</strong></a></li>
